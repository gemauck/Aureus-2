...
const Calendar = () => {
    ...
    return (
        <>
            ...
            {!showDailyNotes ? (
                <div
                    className={`${isDark ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl border shadow-lg p-2 w-full max-w-md mx-auto transition-all duration-200`}
