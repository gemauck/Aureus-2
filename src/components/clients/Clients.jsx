...
const Clients = React.memo(() => {
    ...
    return (
        <div className="flex flex-col h-full w-full max-w-full overflow-hidden" style={{ width: '100%', maxWidth: '100%', minWidth: '100%', height: '100%', minHeight: '100%' }}>
            <div className="flex-shrink-0 space-y-5 sm:space-y-8 pl-6 sm:pl-8 pr-4 sm:pr-6 pt-5 sm:pt-6 pb-2 w-full max-w-full" style={{ width: '100%', maxWidth: '100%' }}>
            {/* Modern Header */}
        ...
        {viewMode !== 'client-detail' && viewMode !== 'lead-detail' && viewMode !== 'pipeline' && (
            ...
            <div className="flex-1 overflow-hidden pl-6 sm:pl-8 pr-4 sm:pr-6 pb-5 sm:pb-6 pt-2 min-h-0">
