                ...
                <div className="overflow-x-auto" ref={tableRef}>
                    <table className="min-w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                <th className="px-2.5 py-1.5 text-left text-[10px] font-semibold text-gray-700 uppercase tracking-wide sticky left-0 bg-gray-50 z-30 border-r border-gray-200">
                                    Document / Data
                                </th>
                            ...
                            {sections.length === 0 ? (
                                ...
                                sections.map((section, sectionIndex) => (
                                    <React.Fragment key={section.id}>
                                        ...
                                        >
                                                    <td className="px-2.5 py-2 sticky left-0 bg-gray-100 z-30 border-r border-gray-200">
                                                <div className="flex items-center gap-2">
