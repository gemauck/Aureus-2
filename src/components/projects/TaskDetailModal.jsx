...
const TaskDetailModal = ({ 
    ...
    const handleAddComment = async () => {
        if (newComment.trim() || commentAttachments.length > 0) {
            ...
            // Notifications for task comments are handled server-side by /api/task-comments.
            // Keeping a single backend notification path avoids duplicate in-app/email sends.
            } finally {
