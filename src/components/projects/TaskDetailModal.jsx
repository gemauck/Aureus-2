    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto" style={{ padding: '0.5rem' }}>
            <div className="min-h-full flex items-start sm:items-center justify-center py-2 sm:py-4">
                ...
                {/* Header */}
                <div className="border-b border-gray-200 px-3 sm:px-4 py-3 bg-white">
                ...
                {/* Footer */}
                <div className="border-t border-gray-200 px-3 sm:px-4 py-2.5 flex justify-between items-center bg-white">
                    <div>
