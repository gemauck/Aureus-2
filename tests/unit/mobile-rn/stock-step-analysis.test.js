...
describe('mobile Stock step loading parity', () => {
  test('job card mode uses on-hand only; stock take uses full catalog at location', () => {
  ...
  test('job card SearchableSelect options stay small vs allSkus', () => {
    const catalog = mockCatalog(509, 65);
...
describe('OTA update contract', () => {
  test('applies staged downloads on cold start; prompts during active session', () => {
    const behavior = {
