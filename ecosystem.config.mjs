export default {
  apps: [{
    ...
    env: {
      ...
      DATABASE_URL: 'postgresql://doadmin:CHANGE_PASSWORD@dbaas-db-6934625-nov-3-backup-nov-3-backup4-nov-6-backup-do-use.l.db.ondigitalocean.com:25060/defaultdb?sslmode=require',
