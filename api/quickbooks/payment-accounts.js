/**
 * GET /api/quickbooks/payment-accounts — QBO bank/credit accounts for purchase payment source (admin).
 */
...
import { fetchQboPaymentAccounts, getQuickBooksClient } from '../_lib/quickbooksOnline.js'
...
async function handler(req, res) {
  try {
    ...
    const rows = await fetchQboPaymentAccounts(client.accessToken, client.realmId)
    ...
    console.error('quickbooks payment-accounts:', e)
    return serverError(res, 'Failed to load payment accounts', e.message)
  }
}
